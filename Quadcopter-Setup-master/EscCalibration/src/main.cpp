...
4. PLUG IN BATTERY  
5. WAIT FOR MOTORS TO FINISH BEEPING 
6. MOVE THORTTLE TO LOW POSITION
7. ESC ARE NOW CALIBRATED 
8. MOVE THROTTLE UP AGAIN TO TEST CALIBRATION
9. IF MOTORS DO NOT ALL START AT THE SAME TIME START OVER
Created by: Joshua Wallace 
Date: 7/18/19
Updated: 8/21/19
Forgot plug in battery part of instructions 
Simplified the interrupt 
*/
